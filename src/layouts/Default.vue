  ...
  <div>
      <section
        ...
        :style="
          ...
          user.backgroundColorLeft +
          ', ' +
          user.backgroundColorRight +
          ');color: ' +
          user.fontColor +
          ';'
        "
      >
        ...
        <h1 class="project-name">{{ user.blogTitle }}</h1>
        <h2 class="project-tagline">{{ user.blogDescribe }}</h2>
        <a
          ...
          <el-row>
            <el-col :span="10">
              ...
              >
                ...
                <el-submenu index="#webSites" v-if="user.webSites.length > 0">
                  <template slot="title">其他网站</template>
                  <el-menu-item
                    :index="'#webSites-' + index"
                    v-for="(item, index) in user.webSites"
                    :key="'#webSites' + index"
            ...
            >
              ...
              <audio ref="music" loop autoplay v-if="user.audioAutoPlay">
      ...
      <section class="main-content">
        <el-row>
          <el-col :span="6" style="padding-right: 10px">
            <sidebar :mini="user.mini"></sidebar>
          </el-col>
...
export default {
  ...
  methods: {
    selectTopbar(index) {
      ...
      switch (index) {
        case "#githubHome":
          window.open("https://github.com/" + this.user.githubUsername);
          break;
        case "#blog":
          if (this.user.blog) {
            window.open(
              (this.user.blog.match(/https?:\/\//i) ? "" : "https://") + this.user.blog
            );
          } else {
            this.$message({
              message: "博主没有其他博客",
        ...
        default:
          if (/#webSites-\d+/.test(index)) {
            ...
            let url = this.user.webSites[i].url;
